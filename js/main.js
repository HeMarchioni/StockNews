...
//=================== TEMPO ==================================================================================================================================================================  
var time_index = function () {setInterval(scrapping_noticias, 900000) };    // -> tempo de atualização das noticias se o site permanecer aberto (900000 milisegundos = 15min)

var time_mercado = function () {setInterval(scrapping_altas_baixas, 600000);  // -> tempo de atualização das altas e baixas do dia se o site permanecer aberto (600000 milisegundos = 10min)
                                setInterval(scrapping_indices, 300000)};     // ->  tempo de atualização dos indices mundiais se o site permanecer aberto (300000 milisegundos = 5min)
//=============================================================================================================================================================================================
...
function scrapping_altas_baixas(){
    ...
    fetch("https://cors-anywhere.herokuapp.com"+url_status)
        ...
        let img_altas_baixas = document.getElementsByClassName("imagem");
        let nome_papel = document.getElementsByClassName("nome");
        let preco_papel = document.getElementsByClassName("preco");
        ...
        //---------------------------------------------------------------------------------------------------    
            ...
            img_altas_baixas[aux_i].attributes[1].value = obj_papeis["papel_"+aux_i].imagem_icone;   // --> colocando as imagens
...
function scrapping_noticias(){
        ...
        let div_noticias = document.querySelector("div[class='noticias']");
...
function scrapping_indices(){                        
        ...
        let pontos_indice = document.getElementsByClassName("pontos_indice");
        let varia_indice = document.getElementsByClassName("varia_indice");
